...
BASE_SAVE_PATH = (MODELS_DIR_PATH / 'TD3_pos_control').resolve(strict=True)
...
# Env params
GYM_ID = 'UWRTArmSim-v0'
# GYM_ID = 'Gen3Lite2FArmEnv-v0'

''' below is from workspace analysis '''
# starting arm location
# starting arm position
# STARTING_ARM_POSITION = np.array([0.6, 0.0, 0.9])
STARTING_ARM_POSITION = np.array([0.5, 0.0, 0.6])
